...
from utils.general import LOGGER, check_version, make_divisible, print_args
...
############ self.grid and self.anchor_grid were modified ############
class Detect(nn.Module):
    ...
    ### this func has some modifications from the original paper ###
...
### Some modification from class DetectionModel(BaseModel) ###
